 ...
 */
@Data
public class WarehouseVertexesListMqttReq {
     ...
     */
    public static WarehouseVertexesListMqttReq fromJson(String jsonStr) {
        try {
            return JSONObject.parseObject(jsonStr, WarehouseVertexesListMqttReq.class);
        } catch (Exception e) {
